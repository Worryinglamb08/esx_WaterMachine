...
Config.Zones = {
	...
	Sprunk = {
		Items = {},
		Pos = {
			{x = 720.48,	y = -974.71,  z = 24.91},
			{x = 814.11,	y = -2973.16, z = 6.02},
			{x = 1048.61,	y = 2662.5,   z = 39.55},
			{x = -323.46,	y = 6229.17,  z = 31.49},
			{x = -2194.58,  y = 4289.42,  z = 49.17},
			{x = -1694.95,	y = -1125.12, z = 13.15}, 
			{x = -1236.28,	y = -1449.35, z = 4.34},
